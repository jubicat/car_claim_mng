...
class ArgonButton extends StatefulWidget {
  ...
  ArgonButton(
      ...
      this.minWidth = 0,
      this.loader,
      this.animationDuration = AnimationConsts.kAppAnimDuration,
...
class ArgonButtonState extends State<ArgonButton> with TickerProviderStateMixin {
  double? loaderWidth;
...
class _ArgonTimerButtonState extends State<ArgonTimerButton> with TickerProviderStateMixin {
  ...
  void startTimer(int newTime) {
    if (newTime == 0) {
      logger.e("Count Down Time can not be null");
    }
